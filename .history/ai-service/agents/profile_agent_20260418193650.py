...
"""
    ...
    try:
        ...
        if "RESOURCE_EXHAUSTED" in str(e) or "quota" in str(e).lower():
            ...
            print("⚠️ Quota exceeded, using mock profile data")
            state["percentile"] = 85.0  # Mock percentile
            state["category"] = "GOPENS"  # Mock category
            state["district"] = None
            state["branches"] = ["CS", "IT"]
            state["budget"] = 100000
            state["hostel_needed"] = False
        else:
